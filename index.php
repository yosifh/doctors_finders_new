      ...
      <div class="container-fluid">
        <div class="banner-wrapper">
          <div class="banner-header text-center">
            ...
            <p> اكتشف أفضل الأطباء حسب الأختصاص و المدينة الأقرب إليك.
          ...
          <div class="search-box">
            <form action="with_slect_city.php" method="POST">
              <div class="form-group search-location">
                ...
                <span class="form-text">أختر مدينتك</span>
              </div>
              <div class="form-group search-info">
                ...
                <span class="form-text">أختار الأختصاص مثل الطب الرياضي و غيرها</span>
              </div>
